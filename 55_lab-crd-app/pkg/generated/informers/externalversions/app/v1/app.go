...
import (
	appv1 "55_lab-crd-app/pkg/apis/app/v1"
	...
	v1 "55_lab-crd-app/pkg/generated/listers/app/v1"
	"context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppV1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppV1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&appv1.App{},
		resyncPeriod,
