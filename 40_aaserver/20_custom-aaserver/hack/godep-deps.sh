...
mkdir -p ${goPath}/src/20_custom-aaserver
cp -R . ${goPath}/src/20_custom-aaserver

pushd ${goPath}/src/20_custom-aaserver
rm -rf vendor || true
...
mv ${goPath}/src/20_custom-aaserver/vendor .
mv ${goPath}/src/20_custom-aaserver/Godeps .
git add vendor
git add Godeps
