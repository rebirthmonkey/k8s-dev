...
import (
	...
	versioned "github.com/rebirthmonkey/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/rebirthmonkey/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/rebirthmonkey/pkg/generated/listers/wukong.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WukongV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WukongV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&wukongcomv1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wukongcomv1.Foo{}, f.defaultInformer)
}
