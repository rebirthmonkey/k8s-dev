...
var pizzasResource = schema.GroupVersionResource{Group: "restaurant.wukong.com", Version: "v1alpha1", Resource: "pizzas"}

var pizzasKind = schema.GroupVersionKind{Group: "restaurant.wukong.com", Version: "v1alpha1", Kind: "Pizza"}
...
func (c *FakePizzas) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(pizzasResource, c.ns, name, opts), &v1alpha1.Pizza{})
