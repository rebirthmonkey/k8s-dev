...
require (
	...
	github.com/rebirthmonkey/go v0.0.0-20230213010807-f2b501ef7ddf
	github.com/rebirthmonkey/k8s-dev v0.0.0-00010101000000-000000000000
	k8s.io/api v0.26.1
...
require (
	...
	gopkg.in/multierror.v1 v1.0.2 // indirect
