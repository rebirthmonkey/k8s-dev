...
import (
	appcontrollerv1alpha1 "55_lab-crd-app/pkg/apis/appcontroller/v1alpha1"
	versioned "55_lab-crd-app/pkg/generated/clientset/versioned"
	internalinterfaces "55_lab-crd-app/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "55_lab-crd-app/pkg/generated/listers/appcontroller/v1alpha1"
	"context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppcontrollerV1alpha1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppcontrollerV1alpha1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&appcontrollerv1alpha1.App{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appcontrollerv1alpha1.App{}, f.defaultInformer)
}
